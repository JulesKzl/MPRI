...
int main (int argc, char **argv)
{
    ...
    }
  {
    ...
    // Ca prend 64 fois trop de place.  Mais C-- n'a pas les operations &, |,
    ...
    fprintf(stderr, "Initialisation tableau OK\n.");
    fflush (stderr);
    zero_sieve (bits, n);
    fprintf(stderr, "Appel zero_sieve OK\n.");
    fflush (stderr);
    bits[0] = bits[1] = 1;
    fprintf(stderr, "Init n=0,1  OK\n.");
    fill_sieve (bits, n);
    fprintf(stderr, "Appel fill_sieve OK\n.");
    fflush (stderr);
    print_sieve (bits, n);
    fprintf(stderr, "\nAppel print_sieve OK\n.");
    fflush (stderr);
